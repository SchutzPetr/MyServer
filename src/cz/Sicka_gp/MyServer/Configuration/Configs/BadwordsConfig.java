...
public class BadwordsConfig {
	...
	public BadwordsConfig(MyServer instance){
		plugin = instance;
	}
	...
	public void reloadConfig() {
	    if (configfile == null) {
	    	configfile = new File(plugin.getDataFolder(), "badwords.yml");
	    }
	    config = YamlConfiguration.loadConfiguration(configfile);
	 
	    // Look for defaults in the jar
	    InputStream defConfigStream = plugin.getResource("badwords.yml");
